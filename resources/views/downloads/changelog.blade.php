...
<div class="container-fluid my-5 p-5" style="background-color: #303030; border-radius: 10px;">
	...
	<div class="row my-5">
		<div class="col">
			...
			<span>Defensive Measures Add-on (Win 10): <a href='{{$version->win10_link}}' target="_tab">Mediafire</a></span><br>
			<span>Defensive Measures Add-on (Mobile): <a href='{{$version->mobile_link}}' target="_tab">Mediafire</a></span><br>
			<small>
				<small>
